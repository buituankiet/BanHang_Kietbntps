...
//---------------------------------------------------------------------------------------------------------//
		...
		{
			DataTable all = DataAccseL.ExecuteData(CommandType.StoredProcedure, "LOAISANPHAM_SelectAll", null);
			return all;
		}
		public static DataTable SelectTop(string Top ,string Where,string Order)
		{
			...
			DataTable all = DataAccseL.ExecuteData(CommandType.StoredProcedure, "LOAISANPHAM_SelectTop", pr);
			return all;
		}
		public static ELOAISANPHAM SelectByID(string MAL)
		{
			...
			IDataReader idr = DataAccseL.ExecuteReader(CommandType.StoredProcedure, "LOAISANPHAM_SelectByID", pr);
			if (idr.Read())
		...
		public static bool TestByID(string MAL)
		{
			...
			DataAccseL.ExecuteNonQuery(CommandType.StoredProcedure,"LOAISANPHAM_TestByID", pr);
		...
		public static DataTable SelectPage(int CurrentPage, int PageSize, out int RowCount)
		{
			...
			DataTable all = DataAccseL.ExecuteData(CommandType.StoredProcedure, "LOAISANPHAM_SelectPage", pr);
...
//---------------------------------------------------------------------------------------------------------//
		public static void Insert(ELOAISANPHAM OLOAISANPHAM)
		{
			...
			DataAccseL.ExecuteNonQuery(CommandType.StoredProcedure, "LOAISANPHAM_Insert", pr);		}
		...
		public static void Delete(string MAL)
		{
			SqlParameter[] pr = new SqlParameter[1];
			pr[0] = new SqlParameter(@"MAL", MAL);
			DataAccseL.ExecuteNonQuery(CommandType.StoredProcedure, "LOAISANPHAM_Delete", pr);		}
//---------------------------------------------------------------------------------------------------------//
...
//---------------------------------------------------------------------------------------------------------//
		...
		List<ELOAISANPHAM> list = new List<ELOAISANPHAM>();
			IDataReader idr = DataAccseL.ExecuteReader(CommandType.StoredProcedure, "LOAISANPHAM_SelectAll", null);
			while (idr.Read())
		...
		public static List<ELOAISANPHAM> ListTop(string Top ,string Where,string Order)
		{
			...
			pr[2] = new SqlParameter(@"Order", Order);
			List<ELOAISANPHAM> list = new List<ELOAISANPHAM>();
			IDataReader idr = DataAccseL.ExecuteReader(CommandType.StoredProcedure, "LOAISANPHAM_SelectTop", pr);
			while (idr.Read())
				list.Add(GetOneLOAISANPHAM(idr));
			if (idr.IsClosed == false)
			{
		...
		public static List<ELOAISANPHAM> ListPage(int CurrentPage, int PageSize, out int RowCount)
		{
			...
			pr[2].Direction = ParameterDirection.Output;
			List<ELOAISANPHAM> list = new List<ELOAISANPHAM>();
			IDataReader idr = DataAccseL.ExecuteReader(CommandType.StoredProcedure, "LOAISANPHAM_SelectPage", pr);
			while (idr.Read())
				list.Add(GetOneLOAISANPHAM(idr));
			if (idr.IsClosed == false)
			{
