...
namespace Banhang.Business
{
    public class BKHACHHANG
    {
        ...
        {
            DataTable all = DataAccseL.ExecuteData(CommandType.StoredProcedure, "KHACHHANG_SelectAll", null);
            return all;
        }
        ...
        public static DataTable SelectTop(string Top, string Where, string Order)
        {
            ...
            DataTable all = DataAccseL.ExecuteData(CommandType.StoredProcedure, "KHACHHANG_SelectTop", pr);
            return all;
        }
        ...
        public static bool TestByID(string MAKH)
        {
            ...
            DataAccseL.ExecuteNonQuery(CommandType.StoredProcedure, "KHACHHANG_TestByID", pr);
        ...
        public static DataTable SelectPage(int CurrentPage, int PageSize, out int RowCount)
        {
            ...
            DataTable all = DataAccseL.ExecuteData(CommandType.StoredProcedure, "KHACHHANG_SelectPage", pr);
        ...
        public static List<EKHACHHANG> ListAll()
        {
            ...
            IDataReader idr = DataAccseL.ExecuteReader(CommandType.StoredProcedure, "KHACHHANG_SelectAll", null);
            while (idr.Read())
        ...
        public static List<EKHACHHANG> ListTop(string Top, string Where, string Order)
        {
            ...
            pr[2] = new SqlParameter(@"Order", Order);
            List<EKHACHHANG> list = new List<EKHACHHANG>();
            IDataReader idr = DataAccseL.ExecuteReader(CommandType.StoredProcedure, "KHACHHANG_SelectTop", pr);
            while (idr.Read())
                list.Add(GetOneKHACHHANG(idr));
            if (idr.IsClosed == false)
            {
        ...
        public static List<EKHACHHANG> ListPage(int CurrentPage, int PageSize, out int RowCount)
        {
            ...
            pr[2].Direction = ParameterDirection.Output;
            List<EKHACHHANG> list = new List<EKHACHHANG>();
            IDataReader idr = DataAccseL.ExecuteReader(CommandType.StoredProcedure, "KHACHHANG_SelectPage", pr);
            while (idr.Read())
                list.Add(GetOneKHACHHANG(idr));
            if (idr.IsClosed == false)
            {
