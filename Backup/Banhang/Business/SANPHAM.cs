...
//---------------------------------------------------------------------------------------------------------//
		...
		{
			DataTable all = SqlHelper.ExecuteData(CommandType.StoredProcedure, "SANPHAM_SelectAll", null);
			return all;
		}
		public static DataTable SelectTop(string Top ,string Where,string Order)
		{
			...
			DataTable all = SqlHelper.ExecuteData(CommandType.StoredProcedure, "SANPHAM_SelectTop", pr);
			return all;
		}
		public static ESANPHAM SelectByID(string MASP)
		{
			...
			IDataReader idr = SqlHelper.ExecuteReader(CommandType.StoredProcedure, "SANPHAM_SelectByID", pr);
			if (idr.Read())
		...
		public static bool TestByID(string MASP)
		{
			...
			SqlHelper.ExecuteNonQuery(CommandType.StoredProcedure,"SANPHAM_TestByID", pr);
		...
		public static DataTable SelectPage(int CurrentPage, int PageSize, out int RowCount)
		{
			...
			DataTable all = SqlHelper.ExecuteData(CommandType.StoredProcedure, "SANPHAM_SelectPage", pr);
...
//---------------------------------------------------------------------------------------------------------//
		public static void Insert(ESANPHAM OSANPHAM)
		{
			...
			SqlHelper.ExecuteNonQuery(CommandType.StoredProcedure, "SANPHAM_Insert", pr);		}
		public static void Update(ESANPHAM OSANPHAM)
		{
			...
			pr[3] = new SqlParameter(@"DONGIA", OSANPHAM.DONGIA);
			pr[4] = new SqlParameter(@"MOTA", OSANPHAM.MOTA);
			SqlHelper.ExecuteNonQuery(CommandType.StoredProcedure, "SANPHAM_Update", pr);		}
		public static void Delete(string MASP)
		{
			SqlParameter[] pr = new SqlParameter[1];
			pr[0] = new SqlParameter(@"MASP", MASP);
			SqlHelper.ExecuteNonQuery(CommandType.StoredProcedure, "SANPHAM_Delete", pr);		}
//---------------------------------------------------------------------------------------------------------//
...
//---------------------------------------------------------------------------------------------------------//
		...
		List<ESANPHAM> list = new List<ESANPHAM>();
			IDataReader idr = SqlHelper.ExecuteReader(CommandType.StoredProcedure, "SANPHAM_SelectAll", null);
			while (idr.Read())
		...
		public static List<ESANPHAM> ListTop(string Top ,string Where,string Order)
		{
			...
			pr[2] = new SqlParameter(@"Order", Order);
			List<ESANPHAM> list = new List<ESANPHAM>();
			IDataReader idr = SqlHelper.ExecuteReader(CommandType.StoredProcedure, "SANPHAM_SelectTop", pr);
			while (idr.Read())
				list.Add(GetOneSANPHAM(idr));
			if (idr.IsClosed == false)
			{
		...
		public static List<ESANPHAM> ListPage(int CurrentPage, int PageSize, out int RowCount)
		{
			...
			pr[2].Direction = ParameterDirection.Output;
			List<ESANPHAM> list = new List<ESANPHAM>();
			IDataReader idr = SqlHelper.ExecuteReader(CommandType.StoredProcedure, "SANPHAM_SelectPage", pr);
			while (idr.Read())
				list.Add(GetOneSANPHAM(idr));
			if (idr.IsClosed == false)
			{
